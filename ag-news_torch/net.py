...
class VDCNN(nn.Module):
    ...
    def __init__(self, n_classes=2, num_embedding=141, embedding_dim=16, depth=9, n_fc_neurons=2048, shortcut=True, h = 0.1):
        ...
        if depth == 9:
            ...
            n_conv_block_64, n_conv_block_128, n_conv_block_256, n_conv_block_512 = 10, 10, 7, 5
        elif depth == 68:
            n_conv_block_64, n_conv_block_128, n_conv_block_256, n_conv_block_512 = 11, 11, 8, 4
